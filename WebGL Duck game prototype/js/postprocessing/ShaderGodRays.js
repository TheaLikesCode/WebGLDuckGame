	...
	'godrays_combine': {
		...
		fragmentShader: [
			...
			//	"gl_FragColor = texture2D( tColors, vUv ) + fGodRayIntensity * vec4( 1.0 + texture2D( tGodRays, vUv ).r );",
				...
				"gl_FragColor = texture2D( tColors, vUv ) + vec4( 0.0 + texture2D( tGodRays, vUv ).r *0.79*max((0.05),-fGodRayIntensity*0.000000001))*vec4( 0.5 + texture2D( tGodRays, vUv ).r /0.79  );",
				"else gl_FragColor = texture2D( tColors, vUv ); ",
