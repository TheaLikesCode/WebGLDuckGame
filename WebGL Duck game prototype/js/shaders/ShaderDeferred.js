		...
		fragmentShader : [
			...
			"void main() {",
				...
				"if ( NdotL2 * NdotL > 0.0 ) {",
					...
					// diffuse
						"vec2 texCoord = vUv;",
					"vec4 colorMap = texture2D( texture,vUv );",
			   		"vec3 emissiveColor =  colorMap.rgb/* float_to_vec3( abs( colorMap.w ) )*/;",
					...
					"if ( specAngle > 0.0 ) {",
						...
						"specular =  emissiveColor* specularColor * specFactor * specAngle * diffuse;",
